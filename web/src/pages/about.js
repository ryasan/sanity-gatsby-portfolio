...
const paragraphs = [
  ...
  `I haven't always been interested in software though. My career background has actually been rooted elsewhere
   in technology. To me, application development just seemed like a path for the intellectually gifted
   and I really just never thought of myself as the type. Nonetheless, I started to put in work and
   developed new learning habits because it was interesting to me.`,
